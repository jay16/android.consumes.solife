...
import us.solife.androidcharts.entity.TitleValueEntity;
import us.solife.androidcharts.view.CandleStickChart;
import us.solife.androidcharts.view.GridChart;
import us.solife.androidcharts.view.LineChart;
import us.solife.androidcharts.view.MACandleStickChart;
import us.solife.androidcharts.view.MAStickChart;
...
public class TabChart extends BaseActivity {
	...
	private void initStickChart()
	{
       ...
       stickchart.setStickFillColor(getResources().getColor(R.color.yellow));
	...
	private void initMAStickChart()
	{
        ...
        mastickchart.setStickFillColor(getResources().getColor(R.color.yellow));
    ...
    private void initPieChart()
    {
		...
		data3.add(new TitleValueColorEntity(getResources().getString(R.string.piechart_title1),2,getResources().getColor(R.color.red)));
		data3.add(new TitleValueColorEntity(getResources().getString(R.string.piechart_title2),3,getResources().getColor(R.color.orange)));
		data3.add(new TitleValueColorEntity(getResources().getString(R.string.piechart_title3),6,getResources().getColor(R.color.yellow)));
		data3.add(new TitleValueColorEntity(getResources().getString(R.string.piechart_title4),2,getResources().getColor(R.color.lightgreen)));
		data3.add(new TitleValueColorEntity(getResources().getString(R.string.piechart_title5),2,getResources().getColor(R.color.green)));
